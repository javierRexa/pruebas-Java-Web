...
<html>
    ...
    <body>
        ...
        <div class="container mt-5"> 
            <div class="row">
                <div class="col-sm">
                    <form action="editarEmpleado.jsp" method="post">
                        ...
                        <button type="submit" name="enviar" class="btn btn-primary">Enviar <i class="fa fa-floppy-o" aria-hidden="true"></i></button>
